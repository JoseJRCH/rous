...
let para = "Rous"; // valor por defecto
let mensaje = `¡Feliz Día del Niño! 🎉 Sé que todavía no regresas y que estás de viaje, pero no quería dejar pasar el día sin enviarte un mensaje.

Te confieso que la oficina no es lo mismo sin ti. Los días se hacen eternos 🥱 y el ambiente ha perdido toda su chispa ✨. Nos hace falta tu risa y esa energía única que tienes.

Y justo hoy, en el Día del Niño, me doy cuenta de que eres tú quien nos recuerda la magia de esta fecha. Tienes esa perspectiva de la vida tan auténtica y divertida que es imposible no sonreír cuando estás cerca. 😊 ¡Es un verdadero don!

Así que, aunque no estés aquí, el mejor regalo de este día es saber que te esperamos con ansias. 😉 ¡Que esa niña interior nunca se canse de jugar y ver el mundo con tanta alegría! 🎈 ¡Nos vemos mañana!`;
